...
if (!class_exists('tour_operators')) {
    ...
    class tour_operators {
        ...
        function tours_add_user_cap() {
            ...
            /*$role->add_cap( 'read' );
            $role->add_cap( 'read_bkap_booking');
            $role->add_cap( 'read_others_bkap_bookings' );
            $role->add_cap( 'edit_bkap_booking' );
            $role->add_cap( 'edit_bkap_bookings' );
            $role->add_cap( 'edit_others_bkap_bookings' );
            $role->add_cap( 'edit_private_bkap_bookings' );
            $role->add_cap( 'edit_published_bkap_bookings' );
            $role->add_cap( 'publish_bkap_bookings' );
            $role->add_cap( 'delete_bkap_booking' );
            $role->add_cap( 'delete_bkap_bookings' );
            $role->add_cap( 'delete_others_bkap_bookings' );
            $role->add_cap( 'delete_private_bkap_bookings' );
            $role->add_cap( 'delete_published_bkap_bookings' );

            $roles = array('tour_operator','administrator', 'shop_manager');
            ...
            $capabilities = self::get_tour_operator_capabilities();

            foreach ( $capabilities as $cap_group ) {
                foreach ( $cap_group as $cap ) {
                    $wp_roles->add_cap( 'tour_operator', $cap );
                }
            }
        }
        ...
        function bkap_tours_addon() {
            ...
            *************************************/
                ...
                if( is_admin() ): // checks if the url being accessed is in the admin section
                    ...
                    // loop through all the post objects
                        foreach( $posts as $post ) {
                            ...
                            } else if ( $post->post_type === 'bkap_booking' ) {
            ...
            function operators_activate(){
                ...
                $result->add_cap( 'edit_others_bkap_bookings' );
                $result->add_cap( 'edit_others_wc_bookings' );

                $result->add_cap( 'read' );
                $result->add_cap( 'read_bkap_booking');
                $result->add_cap( 'read_others_bkap_bookings' );
                $result->add_cap( 'edit_bkap_booking' );
                $result->add_cap( 'edit_bkap_bookings' );
                $result->add_cap( 'edit_others_bkap_bookings' );
                $result->add_cap( 'edit_private_bkap_bookings' );
                $result->add_cap( 'edit_published_bkap_bookings' );
                $result->add_cap( 'publish_bkap_bookings' );
                $result->add_cap( 'delete_bkap_booking' );
                $result->add_cap( 'delete_bkap_bookings' );
                $result->add_cap( 'delete_others_bkap_bookings' );
                $result->add_cap( 'delete_private_bkap_bookings' );
                $result->add_cap( 'delete_published_bkap_bookings' );*/
                ...
                // Tour Operator role
                add_role( 'tour_operator', __( 'Tour Operator', 'woocommerce-booking' ), array(
                    'level_9'                => true,
                    'level_8'                => true,
                    'level_7'                => true,
                    'level_6'                => true,
            ...
            /**
             * Get capabilities for Tour Operator.
             *
             * @return array
             */
            private static function get_tour_operator_capabilities() {
                $capabilities = array();
                ...
                $capability_types = array( 'bkap_booking', 'shop_order' );
